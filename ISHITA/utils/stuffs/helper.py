...
__
𝐒ᴘᴇᴄɪᴀʟ 𝐂ᴏᴍᴍᴀɴᴅs 𝐒ᴜᴘᴘᴏʀᴛ 𝐀ʟʟ 𝐄xᴀᴍᴘʟᴇ  - 𝙸𝚜𝚑𝚒𝚝𝚊 𝚋𝚊𝚗 𝙸𝚜𝚑𝚒𝚝𝚊 𝚖𝚞𝚝𝚎 𝙸𝚜𝚑𝚒𝚝𝚊 𝚙𝚛𝚘𝚖𝚘𝚝𝚎 ..... 𝚎𝚝𝚌
'''
    HELP_Search = '''Sᴇᴀʀᴄʜ
...
◌ /q `<username>` : (ᴇxᴘᴇʀɪᴍᴇɴᴛᴀʟ) ᴄʀᴇᴀᴛᴇ ᴀ ϙᴜᴏᴛᴇ ᴡɪᴛʜ ɢɪᴠᴇɴ ᴜsᴇʀɴᴀᴍᴇ ʙʏ ʀᴇᴘʟɪᴇᴅ ᴍᴇssᴀɢᴇ.
'''
