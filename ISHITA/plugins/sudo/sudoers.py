...
from ISHITA.misc import SUDOERS
from ISHITA.utils.database import add_sudo, remove_sudo
from ISHITA.utils.decorators.language import language
from ISHITA.utils.extraction import extract_user
from ISHITA.utils.inline import close_markup
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("❍ ɴᴏᴛ ғᴏʀ ʏᴏᴜ ●", show_alert=True)
    else:
